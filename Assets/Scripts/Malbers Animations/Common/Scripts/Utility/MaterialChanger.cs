...
{
    [SerializeField] public List<MaterialItem> materialList = new List<MaterialItem>();
    [HideInInspector] [SerializeField] public bool showMeshesList = true;
...
{
    [SerializeField] [HideInInspector] public string Name; //The name for the Material to change
